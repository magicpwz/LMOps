    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def forward(
        ...
        x, attn = self.self_attn(
            ...
            key_val=key_val.to("cuda") if key_val is not None else key_val,
            value_val=value_val.to("cuda") if value_val is not None else value_val,
            demons_num=demons_num,
            scalar=scalar,
        )
        # ! ICL analysis
        self_attn_out_hidden = x
        ...
        return x, attn, None, self_attn_out_hidden
